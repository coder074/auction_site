...
export function CarCard({ car, onViewDetails, onPlaceBid }: CarCardProps) {
  const { t } = useLanguage();
      ...
      <div className="p-6">
        <div className="flex justify-between items-start mb-3">
          ...
          <div className="text-right">
            <p className="text-sm text-gray-500">{t('common.currentBid')}</p>
